...
it("ensureAgentCwd installs standard Clash setup/init guidance", async () => {
  ...
  try {
    ...
    expect(agents).toMatch(/clash text\s+pull/);
    expect(agents).toContain("clash text apply");
    expect(agents).toContain("timelines/");
    expect(agents).toContain("projections/timelines/");
    expect(agents).toMatch(/clash timeline\s+pull/);
    expect(agents).toContain("clash timeline apply");
    ...
    expect(agents).toContain("asset/COW commands");
    expect(agents).toContain("product-internal replicator");
    expect(agents).toContain("same local replica");
