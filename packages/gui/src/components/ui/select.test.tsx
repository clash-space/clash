...
describe("SelectMenu", () => {
    ...
    it("routes trigger help text through the shared tooltip primitive instead of browser title attributes", () => {
        const source = readFileSync(join(process.cwd(), "packages/gui/src/components/ui/select.tsx"), "utf8");
        const tooltipSource = readFileSync(join(process.cwd(), "packages/gui/src/components/ui/tooltip.tsx"), "utf8");
