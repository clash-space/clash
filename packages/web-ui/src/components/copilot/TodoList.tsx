...
import { Check, CaretUp, ListChecks } from '@phosphor-icons/react';
...
export function TodoList({ items, title = "Plan" }: TodoListProps) {
        ...
        >
            ...
            >
                <CollapsibleTrigger asChild>
                    <Button
                        className="group/todo-trigger min-h-0 w-full cursor-pointer justify-between rounded-none border-transparent bg-warm-muted px-3 py-2 text-left shadow-none hover:bg-warm-muted/80 focus-visible:ring-inset"
                    >
                        ...
                        <span className="flex items-center gap-2">
                            ...
                            <CaretUp className="w-3 h-3 text-stone-700 transition-transform group-data-[state=open]/todo-trigger:rotate-180 dark:text-stone-300" aria-hidden="true" />
                        </span>
                    </Button>
                </CollapsibleTrigger>

                <CollapsibleContent className="border-t border-warm-border">
                    <motion.div
