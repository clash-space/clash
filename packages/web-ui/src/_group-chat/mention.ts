/**
 * @-mention parser. Extracts the addressee from a user prompt so the
 * GroupChat can route it. The match is greedy on the first @<id> token
 * at the start of the input, optionally trimmed of leading whitespace.
 *
