...
const MODEL_CARD_DEFINITIONS = [
  ...
  // the i2v variant so UI/pricing stays honest per card.
  {
    ...
    provider: 'fal.ai',
    availableProviders: ['jimeng', 'volcengine', 'fal', 'kie', 'replicate'],
  ...
  // ─── Video: Kling 3 Pro (fal.ai) — first frame + optional end frame ────
  {
    ...
    name: 'Kling 3 Pro',
    provider: 'fal.ai',
    availableProviders: ['kling', 'fal', 'kie'],
...
const MODEL_PROVIDER_IMPLEMENTATION_ROWS: ModelProviderImplementationRow[] = [
  ...
  ['gemini-flash-image-2', 'official', 'google-ai-studio', 'google-ai-studio', 'gemini-3.1-flash-image', 12, { region: 'global', credentials: ['apiKey'] }],
  ['gemini-pro-image', 'official', 'google-ai-studio', 'google-ai-studio', 'gemini-3-pro-image', 12, { region: 'global', credentials: ['apiKey'] }],
  ...
  ['gemini-flash-image-2', 'official', 'google-agent-platform', 'google-agent-platform', 'gemini-3.1-flash-image-preview', 10, { region: 'global', credentials: ['vertexCredentials'] }],
  ['gemini-pro-image', 'official', 'google-agent-platform', 'google-agent-platform', 'gemini-3-pro-image-preview', 10, { region: 'global', credentials: ['vertexCredentials'] }],
