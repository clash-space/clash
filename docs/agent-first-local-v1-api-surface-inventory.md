...
- `doctor storage` reports path-boundary, storage-role contract, local SQLite
  metadata index schema, and protected-store health without mutating
  project state.
