...
initialized without the asset reference index schema needed for agent-readable
reference lookups. `clash doctor storage --repair` creates the standard workspace roots,
