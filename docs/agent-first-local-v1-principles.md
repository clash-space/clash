...
create/delete, legacy project update, project restore/purge, session create/delete, local sync config update, local audio config update/install, local harness enablement/install, local agent-server config update, provider account delete,
