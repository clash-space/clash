...
delete/purge, session delete, and asset GC delete, readable through
`GET /api/v1/mutation-audit` and `clash audit mutations`; broader forced
projection/daemon writes should join the same
