...
```text
.tmp/agent-first-cas/2026-07-09T04-32-15-358Z/agent-first-cas-report.json
```
...
```text
.tmp/storage-doctor-repair/2026-07-09T04-32-31-349Z/storage-doctor-repair-report.json
```
...
```text
.tmp/agent-first-local-v1-gate/2026-07-09T04-32-15-199Z/agent-first-local-v1-gate-report.json
```
...
- nested report contracts validated:
  - `.tmp/short-drama-timeline/2026-07-09T04-32-15-261Z/short-drama-timeline-report.json` with 4 checks,
  - `.tmp/agent-first-cas/2026-07-09T04-32-15-358Z/agent-first-cas-report.json` with 56 checks,
  - `.tmp/storage-doctor-repair/2026-07-09T04-32-31-349Z/storage-doctor-repair-report.json` with 86 checks,
  - `.tmp/agent-first-asset-receipts/2026-07-09T04-32-37-680Z/agent-first-asset-receipt-report.json` with 190 checks.
