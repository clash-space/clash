...
```text
.tmp/agent-first-asset-receipts/2026-07-07T13-36-22-931Z/agent-first-asset-receipt-report.json
```

Result:

- `status: pass`,
- 125 checks passed through `npm --prefix apps/desktop run test:e2e:asset-receipts`,
