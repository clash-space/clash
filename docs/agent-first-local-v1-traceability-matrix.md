...
- `packages/cli/src/commands/doctor.ts` adds read-only storage health checks
  ...
  metadata/projection schema, broken/invalid asset links, and legacy `db.json`.
