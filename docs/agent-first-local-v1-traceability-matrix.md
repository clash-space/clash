...
- Timeline is the reference implementation for projection CAS plus first-pass
  ...
  envelope. The remaining gap is richer version UI/history plus adoption by
  future non-JSON/storyboard/editor projections.
