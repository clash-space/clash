...
- Extend first-pass local mutation audit beyond project delete/restore/purge,
  ...
  delete, asset import, custom action upload, asset cover update, asset reference refresh, asset GC delete, local-api canvas node update/delete, local-api canvas batch delete, and local-api canvas edge delete to the remaining
