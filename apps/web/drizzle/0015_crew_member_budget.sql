-- Per-agent budget pockets on crew_member.
--
...
ALTER TABLE `crew_member` ADD COLUMN `budget_credits` INTEGER;
ALTER TABLE `crew_member` ADD COLUMN `budget_period` TEXT DEFAULT 'monthly';
ALTER TABLE `crew_member` ADD COLUMN `budget_used` INTEGER DEFAULT 0;
ALTER TABLE `crew_member` ADD COLUMN `budget_reset_at` INTEGER;
